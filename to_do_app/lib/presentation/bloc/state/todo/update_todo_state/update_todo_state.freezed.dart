...
mixin _$UpdateTodoState {
 ...
 TodoNodeValidator get titleValidator; TodoNodeValidator get descriptionValidator; ProcessState get updateTodoState; ProcessState get loadingDataState; bool get isCompleted;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateTodoState&&(identical(other.titleValidator, titleValidator) || other.titleValidator == titleValidator)&&(identical(other.descriptionValidator, descriptionValidator) || other.descriptionValidator == descriptionValidator)&&(identical(other.updateTodoState, updateTodoState) || other.updateTodoState == updateTodoState)&&(identical(other.loadingDataState, loadingDataState) || other.loadingDataState == loadingDataState)&&(identical(other.isCompleted, isCompleted) || other.isCompleted == isCompleted));
}


@override
int get hashCode => Object.hash(runtimeType,titleValidator,descriptionValidator,updateTodoState,loadingDataState,isCompleted);

@override
String toString() {
  return 'UpdateTodoState(titleValidator: $titleValidator, descriptionValidator: $descriptionValidator, updateTodoState: $updateTodoState, loadingDataState: $loadingDataState, isCompleted: $isCompleted)';
}
...
@useResult
$Res call({
 TodoNodeValidator titleValidator, TodoNodeValidator descriptionValidator, ProcessState updateTodoState, ProcessState loadingDataState, bool isCompleted
});


$ProcessStateCopyWith<$Res> get updateTodoState;$ProcessStateCopyWith<$Res> get loadingDataState;
...
/// Create a copy of UpdateTodoState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? titleValidator = null,Object? descriptionValidator = null,Object? updateTodoState = null,Object? loadingDataState = null,Object? isCompleted = null,}) {
...
as ProcessState,loadingDataState: null == loadingDataState ? _self.loadingDataState : loadingDataState // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$ProcessStateCopyWith<$Res> get loadingDataState {
  
  return $ProcessStateCopyWith<$Res>(_self.loadingDataState, (value) {
    return _then(_self.copyWith(loadingDataState: value));
  });
}
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TodoNodeValidator titleValidator,  TodoNodeValidator descriptionValidator,  ProcessState updateTodoState,  ProcessState loadingDataState,  bool isCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UpdateTodoState() when $default != null:
return $default(_that.titleValidator,_that.descriptionValidator,_that.updateTodoState,_that.loadingDataState,_that.isCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TodoNodeValidator titleValidator,  TodoNodeValidator descriptionValidator,  ProcessState updateTodoState,  ProcessState loadingDataState,  bool isCompleted)  $default,) {final _that = this;
switch (_that) {
case _UpdateTodoState():
return $default(_that.titleValidator,_that.descriptionValidator,_that.updateTodoState,_that.loadingDataState,_that.isCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TodoNodeValidator titleValidator,  TodoNodeValidator descriptionValidator,  ProcessState updateTodoState,  ProcessState loadingDataState,  bool isCompleted)?  $default,) {final _that = this;
switch (_that) {
case _UpdateTodoState() when $default != null:
return $default(_that.titleValidator,_that.descriptionValidator,_that.updateTodoState,_that.loadingDataState,_that.isCompleted);case _:
  return null;
...
class _UpdateTodoState implements UpdateTodoState {
  const _UpdateTodoState({this.titleValidator = const TodoNodeValidator.pure(), this.descriptionValidator = const TodoNodeValidator.pure(), this.updateTodoState = const ProcessState.initial(), this.loadingDataState = const ProcessState.loading(), this.isCompleted = false});
...
@override@JsonKey() final  ProcessState loadingDataState;
...
@override $ProcessStateCopyWith<$Res> get updateTodoState;@override $ProcessStateCopyWith<$Res> get loadingDataState;
...
/// Create a copy of UpdateTodoState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? titleValidator = null,Object? descriptionValidator = null,Object? updateTodoState = null,Object? loadingDataState = null,Object? isCompleted = null,}) {
