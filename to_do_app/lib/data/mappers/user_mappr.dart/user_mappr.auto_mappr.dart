...
/// {@template package:to_do_app/data/mappers/user_mappr.dart/user_mappr.dart}
/// Available mappings:
/// - `User` → `UserEntity`.
/// {@endtemplate}
class $UserMappr implements _i1.AutoMapprInterface {
  ...
  /// {@macro package:to_do_app/data/mappers/user_mappr.dart/user_mappr.dart}
  @override
  ...
  _i3.UserEntity _map__i2$User_To__i3$UserEntity(_i2.User? input) {
    ...
    return _i3.UserEntity(id: model.uid, email: model.email, name: null);
  }
}
